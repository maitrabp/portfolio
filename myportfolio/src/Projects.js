            ...
            <div id="Projects">
                ...
                <div className = "container-fluid" style={{backgroundColor:"white", borderTop:"8px solid black", borderBottom:"8px solid black", textAlign: "center"}}>
                  <div className = "innerSliderContainer">
                      <Slider {...settings}>
                        <Project projImg = "slack.jpg" demo={true} demolink = "slack-clone-96a9b.web.app/" codelink = "https://github.com/maitrabp/slack_clone" projName="Slack Clone" projDesc="Here I've made a clone of the slack server page from scratch using React.js (Context API, Router, Hooks). I've used firebase as back-end to manage channels, chats, messages, and login authentication. Hosting was done through firebase as well."></Project>
