...
export default function About() {
  return (
    <div id="About">
      <div className="mainTitle">ABOUT ME</div>
      <div className="componentSection">
        <span id="bigger">Hello, I'm Maitra Patel!</span> <br></br>I am an
        aspiring software engineer based in{" "}
        <span id="highlighted">Detroit, MI</span>. Developing meaningful
        ...
        <div style={{ textAlign: "left" }}>
          I love keeping up with tech. Here are a few{" "}
          <span id="highlighted">technologies</span> I've been working with
          recently:
        </div>
        <div className="skills">
          ...
          <div className="skillSection2">
            <ul style={{ listStyleType: "disc" }}>
              ...
              <li id="highlighted">Android Studio (Mobile App Development)</li>
            </ul>
          </div>
        </div>{" "}
        <br></br>
        <div style={{ textAlign: "left" }}>
          I have also gained <span id="highlighted">adequate experience</span>{" "}
          in the following:
        </div>
        <div className="skills">
          <div className="skillSection1">
          ...
          <div className="skillSection2">
            <ul style={{ listStyleType: "disc" }}>
              <li id="highlighted">
                <u>Environments</u>: MacOS
              </li>
            </ul>
          </div>
        </div>
        <div style={{ textAlign: "left" }}>
          I am an active job seeker. If you know someone who is hiring, please
          reach out to me{" "}
          <a
            href="#contact"
            style={{ color: "blue", textUnderlineOffset: "true" }}
          >
            here.{" "}
          </a>
        </div>
